    ...
    <div className="min-h-screen bg-white">
      <div className="container-app py-12">
        ...
        <div className="space-y-8">
          ...
          <Card className="p-8 border-2 border-stone-200 hover:border-primary-300 transition-all duration-300">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h3 className="text-2xl font-semibold text-stone-900 mb-2">Recent assignments</h3>
                <p className="text-stone-600">Latest deliveries assigned to you</p>
              </div>
            ...
            {deliveries.length === 0 ? (
              <p className="text-stone-500 py-4">No deliveries assigned.</p>
            ) : (
                ...
                {deliveries.slice(0, 5).map((d) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-stone-600 mt-1">{d.address}</p>
                    </div>
