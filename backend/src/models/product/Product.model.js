...
const productSchema = new mongoose.Schema(
  {
    ...
    minStockAlert: {
      type: Number,
      default: 5,   // vendor notified when stock drops to or below this level
      min: 0,
    },
    ...
    // Tiered bulk pricing: [{ minQty: 10, discountPercent: 5 }, ...]
    bulkPricingTiers: {
      type: [{
    ...
    // Vendor-set discount percentage (clearance / sale)
    vendorDiscountPercent: { type: Number, default: 0, min: 0, max: 100 },

    // Festival discount set by admin, applied platform-wide
    festivalDiscountPercent: { type: Number, default: 0, min: 0, max: 100 },
    ...
    clothingSizes: { type: [String], enum: CLOTHING_SIZES, default: [] },

    // Category-level standard fields
    ...
    // Non-AI rating score (out of 2.5) — computed from reviews + return rate
